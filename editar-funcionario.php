...
try {
    ...
    die("Error en la base de datos: Verifica si el campo 'cargo' existe en la tabla 'funcionario'.");
}
  ...
  <body>
    ...
    <main class="pagina">
      ...
      <section class="tarjeta">
        ...
        <form class="formulario formulario-dos-columnas" action="editar-funcionario.php?id=<?= escapar($idFuncionario) ?>" method="post">
          ...
          <label for="fecha-nacimiento">
            Fecha de nacimiento
            <input id="fecha-nacimiento" type="date" name="fecha_nacimiento" value="<?= escapar($funcionario["fecha_nacimiento"]) ?>">
          </label>
